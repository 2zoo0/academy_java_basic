 ...
 * 제품을 정의하는 클래스
 * -------------------------------------------
 * 캡슐화를 적용하여 모든 데이터 필드는 private으로 선언
 * 
...
public class Product extends Object{
	...
	------------------------------------------------------
	 1. get 으로 시작
	 2. get 뒤에 오는 이름은 접근하려는 멤버변수 명의 첫 글자만 대문자화 하여 정의
	 3. 메소드 매개변수가 없다.
	 4. 메소드 리턴 타입을 접근하려는 멤버변수 타입과 맞춘다.
	 5. 멤버변수의 타입이 boolean 이면 get 이  아니라, is 로 시작하도록 작성
	 6. getXxx(), isXxx() 형태로 정의
	======================================================
	 수정자 메소드 : setter
	------------------------------------------------------
	 1. set 으로 시작
	 2. set 뒤에 오는 이름은 접근하려는 멤버변수 명의 첫 글자만 대문자화 하여 정의
	 3. 메소드 매개변수는 수정하려는 멤버변수의 타입과 맞추고,
	  	보통 같은 이름으로 설정
	 4. 메소드 리턴 타입은 void 로 한다.
	 5. 보통 한쪽의 로직은 this.멤버변수 = 매개변수; 작성
	======================================================
	*/
