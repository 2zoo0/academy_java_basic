...
/**
 * 산술연산을 하는 클래스인 Calculator를 테스트하는 클래스이다.
 * @author PC38207
 *
 */
public class CalculatorTest {
	public static void main(String[] args) {
		...
		// 2. 초기화 : Calculator 클래스의 모든 생성자 정의를 생략하여 기본생성자가  자동 제공됨
		calc = new Calculator(); 
		...
		// 이 클래스에 있는 add()를 사용
		// 이 클래스 자신의 객체르 생성 후 사용 가능
		// (2) static -> non-static : 같은 클래스
		CalculatorTest calculatorTest = new CalculatorTest();
		calculatorTest.add(10, 20);
		
		// 동일클래스 안의 static 영역끼리의 호출 : 이름만으로 바로 사용가능
